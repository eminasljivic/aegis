...
import at.sljivic.aegis.Tracer
import java.io.File
...
actual fun executeExecutable(
    executablePath: String, args: List<String>, timeoutSeconds: Long
): TracingResult {
    ...
    val tracerErrThread = thread(start = true) {
    ...
    val tracerOutThread = thread(start = true) {
    ...
    val outThread = thread(start = true) {
    ...
    val errThread = thread(start = true) {
...
var aarch64_android_syscall_num_to_name = arrayOf(
    Syscall(
        "restart", OperationType.ProcessManagement
    ),
    Syscall(
        "exit", OperationType.ProcessManagement
    ),
    Syscall(
        "fork", OperationType.ProcessManagement
    ),
    Syscall(
        "read", OperationType.File
    ),
    Syscall(
        "write", OperationType.File
    ),
    Syscall(
        "open", OperationType.File
    ),
    Syscall(
        "close", OperationType.File
    ),
    Syscall(
        "sys_waitpid", OperationType.ProcessManagement
    ),
    Syscall(
        "creat", OperationType.File
    ),
    Syscall(
        "link", OperationType.File
    ),
    Syscall(
        "unlink", OperationType.File
    ),
    Syscall(
        "execve", OperationType.ProcessManagement
    ),
    Syscall(
        "chdir", OperationType.File
    ),
    Syscall(
        "time", OperationType.Time
    ),
    Syscall(
        "mknod", OperationType.File
    ),
    Syscall(
        "chmod", OperationType.File
    ),
    Syscall(
        "lchown", OperationType.File
    ),
    Syscall(
        "sys_break", OperationType.File
    ),
    Syscall(
        "sys_stat", OperationType.File
    ),
    Syscall(
        "lseek", OperationType.File
    ),
    Syscall(
        "getpid", OperationType.ProcessManagement
    ),
    Syscall(
        "mount", OperationType.File
    ),
    Syscall(
        "umount", OperationType.File
    ),
    Syscall(
        "setuid", OperationType.ProcessManagement
    ),
    Syscall(
        "getuid", OperationType.ProcessManagement
    ),
    Syscall(
        "stime", OperationType.Time
    ),
    Syscall(
        "ptrace", OperationType.ProcessManagement
    ),
    Syscall(
        "alarm", OperationType.Time
    ),
    Syscall(
        "sys_fstat", OperationType.File
    ),
    Syscall(
        "pause", OperationType.Time
    ),
    Syscall(
        "utime", OperationType.Time
    ),
    Syscall(
        "sys_stty", OperationType.File
    ),
    Syscall(
        "sys_gtty", OperationType.File
    ),
    Syscall(
        "access", OperationType.File
    ),
    Syscall(
        "nice", OperationType.ProcessManagement
    ),
    Syscall(
        "sys_ftime", OperationType.Time
    ),
    Syscall(
        "sync", OperationType.Sync
    ),
    Syscall(
        "kill", OperationType.ProcessManagement
    ),
    Syscall(
        "rename", OperationType.File
    ),
    Syscall(
        "mkdir", OperationType.File
    ),
    Syscall(
        "rmdir", OperationType.File
    ),
    Syscall(
        "dup", OperationType.File
    ),
    Syscall(
        "pipe", OperationType.File
    ),
    Syscall(
        "times", OperationType.Time
    ),
    Syscall(
        "sys_prof", OperationType.File
    ),
    Syscall(
        "brk", OperationType.Memory
    ),
    Syscall(
        "setgid", OperationType.ProcessManagement
    ),
