...
var aarch64_android_syscall_num_to_name =
        arrayOf(
                ...
                Syscall("sys_signal", OperationType.Singal),
                ...
                Syscall("sys_ulimit", OperationType.Resource),
                Syscall("sys_olduname", OperationType.Resource),
                ...
                Syscall("sethostname", OperationType.Resource),
                Syscall("setrlimit", OperationType.Resource),
                Syscall("getrlimit", OperationType.Resource),
                Syscall("getrusage", OperationType.Resource),
                ...
                Syscall("syslog", OperationType.Resource),
